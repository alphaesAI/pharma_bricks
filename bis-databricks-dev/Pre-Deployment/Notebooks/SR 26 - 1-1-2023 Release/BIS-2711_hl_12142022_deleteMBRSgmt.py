...
for client in clientlist:
  if client != "global":
    membershipGoldPath = f'/mnt/{client}/Gold/MA/Risk/Membership'
    SegementGoldPath = f'/mnt/{client}/Gold/MA/Risk/Segment'
  
    
    if path_exists(membershipGoldPath):     
      drop_deltaDir(membershipGoldPath)
      print(f"old gold risk table Membership dropped successfully for client: {client}!")
   
      
    if path_exists(SegementGoldPath):        
      drop_deltaDir(SegementGoldPath)
      print(f"old gold risk table Segment dropped successfully for client: {client}!")
