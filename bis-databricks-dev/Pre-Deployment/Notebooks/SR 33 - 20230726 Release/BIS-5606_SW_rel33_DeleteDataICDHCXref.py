...
# MAGIC - gold_icdhccxref
# MAGIC - gold_ma_supplementaldiagnosis
...
for ent in EntityDelCollect:
  ...
  if(clientCode != "global"):
    ...
    try:
      deleteData(clientCode, "gold_ma_supplementaldiagnosis")
    except Exception as e:
      print(str(e))
  
  elif(clientCode == "global"):
    print(f"INFO: Begin deleting for Client: {clientCode}")
    try:
      deleteData(clientCode, "gold_icdhccxref")
    except Exception as e:
      print(str(e))  
