...
var consolidated = rawDf
  ...
  //data format
    ...
    .withColumn("DateOfDeath", col("DateOfDeath").cast(IntegerType))
    .withColumn("RecentEnrollmentDate", col("RecentEnrollmentDate").cast(IntegerType))
    .withColumn("RecentDisenrollmentDate", col("RecentDisenrollmentDate").cast(IntegerType))
