...
var consolidated = spark.readStream
    .format("delta")
    .option("ignoreChanges", "true")
    .load(consolidatedPath)

// drop the duplicates 
consolidated = consolidated.dropDuplicates("GeneratedGoldenClaimsUniqueKey","LoadTimestamp")
// rename key
consolidated = consolidated.withColumnRenamed("GeneratedGoldenUniqueClaimsKey", "GeneratedGoldenClaimsUniqueKey")
