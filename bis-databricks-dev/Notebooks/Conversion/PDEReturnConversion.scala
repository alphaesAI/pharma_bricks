...
val dfHeader = createFixedWidthDF(dfData, expContolNames, "HDR")

//Trailer - Pass in header array and data dataframe
val dfTrailer = createFixedWidthDF(dfData, expContolNames, "TLR")
...
val dfControlFile: DataFrame = dfHeader.alias("h")
                                        ...
                                        .select("h.SubmitterID", "h.TransDate", "h.DDPSSystemDate", "h.DDPSSystemTime","h.DDPSReportID","t.TlrDetRecordTotal", "FILE_ID")
