...
dbutils.widgets.text("ConversionJsonFileName","","") //mmrcurrent_conversion.json
dbutils.widgets.text("HasControlFile","","") //mmrcurrent_conversion.json
...
// DBTITLE 1,Write DataFrame to Converted Folder
