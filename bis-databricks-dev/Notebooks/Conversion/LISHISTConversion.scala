...
val dfHheader = createFixedWidthDF(dfData, expContolNames, "H")

//Trailer - Pass in header array and data dataframe
val dfTtrailer = createFixedWidthDF(dfData, expContolNames, "T")

//Data - Pass in detail array and data dataframe
val dfDetail = createFixedWidthDF(dfData, expColumnNames, "D")
