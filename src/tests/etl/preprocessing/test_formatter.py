...
def test_formatter_with_mocked_parser_output():
    mock_generic_json = {
    ...
    assert "detail" in structured_json
    ...
    assert billing_provider.get("billing_provider_name") == "METRO HEALTH CENTER"